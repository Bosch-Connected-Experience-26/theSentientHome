...
st.set_page_config(
    page_title="Smart Home Assistant (AgentCore)",
    page_icon="🏠",
    layout="wide"
)
...
def main():
    ...
    st.markdown(f"""
    Ask about your home, appliances, energy, or run quick actions (e.g., 'I want to take a break for the next 2h').
    ...
    **Region:** {region}
    ...
    # Quick action button
    if st.button("Take a break (2h)"):
        prompt = "I want to take a break for the next 2h"
    else:
        prompt = st.chat_input("Ask about your smart home or run an action...")
